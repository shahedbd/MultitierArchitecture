using MySchool.DBRepo.Infrastructure;
using MySchool.DBRepo.Repositories.Interfaces;
using MySchool.Model.DBModel;
using MySchool.Shared.Log;
using MySchool.Shared.Utility;
using System;
...
namespace MySchool.DBRepo.Repositories.Services
    ...
    public class PersonalInfoRepository : DBOperations<PersonalInfo>, IRepository<PersonalInfo>
    {
        ...
        public async Task<string> Insert(PersonalInfo entity)
        {
            try
            {
                ...
                var result = await ExecuteStoredProc(cmd);
                return result;
            }
            catch (Exception ex)
            {
        ...
        public async Task<IEnumerable<PersonalInfo>> GetAll()
        {
            try
            {
                ...
                var result = await GetAllExecuteStoredProc(cmd);
                return result;
            }
            catch (Exception ex)
            {
        ...
        public async Task<PersonalInfo> GetBy(long PersonalInfoID)
        {
            try
            {
                var cmd = new SqlCommand("sp_PersonalInfo");
                ...
                var result = await GetByExecuteStoredProc(cmd);
                return result;
            }
            catch (Exception ex)
            {
